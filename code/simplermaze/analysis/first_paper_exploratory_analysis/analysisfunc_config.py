...
class Paths: 
    ...
    if session == "3.6":
        ...
        TRIAL_INFO_PATH:str = session_path + r"mouse6357_session3.6_trial_info.csv"
        ...
        TRIAL_INFO_PATH:str = session_path + r"mouse6357_session3.7_trial_info.csv"
        ...
        TRIAL_INFO_PATH:str = session_path + r"mouse6357_session3.8_trial_info.csv"
